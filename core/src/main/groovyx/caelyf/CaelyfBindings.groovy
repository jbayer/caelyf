...
/**
 * If you annotate your classes with the <code>@CaelyfBindings</code> annotation,
...
@GroovyASTTransformationClass(classes = [BindingsTransformation])
@interface CaelyfBindings { }